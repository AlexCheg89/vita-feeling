...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=Philosopher|Roboto&amp;subset=latin,cyrillic">
...
<div id="art-main">
  ...
  <div class="art-sheet clearfix">
    <header class="art-header"><?php echo $view->position('position-30', 'art-nostyle'); ?>
      ...
      <div class="art-positioncontrol art-positioncontrol-1588454145" id="CONTROL-ID-1" data-left="98.99%">
        <?php echo $view->position('position-31', 'art-nostyle'); ?>
      </div>
      <div class="art-positioncontrol art-positioncontrol-1699000200" id="CONTROL-ID-2" data-left="99.14%">
        <?php echo $view->position('position-32', 'art-nostyle'); ?>
      </div>
      <div class="art-positioncontrol art-positioncontrol-1320518358" id="CONTROL-ID-3" data-left="0.96%">
        <?php echo $view->position('position-33', 'art-nostyle'); ?>
      </div>
      <div class="art-positioncontrol art-positioncontrol-1692792530" id="CONTROL-ID-4" data-left="50.52%">
        <?php echo $view->position('position-34', 'art-nostyle'); ?>
      </div>


      <?/*div class="art-textblock art-object1193119118" data-left="83.32%">
  ...
  <footer class="art-footer">
    <div class="art-footer-inner">
      ...
      <?php else: ?>
        <a title="RSS" class="art-rss-tag-icon" style="position: absolute; bottom: 8px; left: 6px; line-height: 36px;" href="#"></>
